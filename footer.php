	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>RIA-CAKE BAKERY</b></h3>
					<p>jl. prabu kiansantang no.51</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +628123456789</p>
					<p><i class="glyphicon glyphicon-envelope"></i> ria-cake@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
		...
		<div class="copy" style="background-color: #ff8680; padding: 5px; color: #fff; text-align: center;">
			<span>Copyright&copy; Ria Septi Fauziyyah</span>
		</div>
	</footer>
